...
xref:nodes-and-volumes/nodes/disks-or-nodes-eviction.adoc[evict the replica to other nodes before draining]. See <<_node_drain_policy_recommendations,Node Drain Policy
