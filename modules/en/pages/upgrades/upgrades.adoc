= Upgrades
:doctype: book
<<<<<<< HEAD:modules/en/pages/deploy/upgrade/index.adoc
:weight: 3
:current-version: {page-component-version}
=======
:current-version: {page-origin-branch}
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/upgrades/upgrades.adoc
