...
____
Global setting: xref:longhorn-longhorn-system/settings.adoc#_replica_node_level_soft_anti_affinity[Replica Node Level Soft Anti-Affinity].
More details in xref:nodes-and-volumes/nodes/scheduling.adoc[Scheduling] and xref:introduction/best-practices.adoc#_replica_node_level_soft_anti_affinity[Best Practices].
____
