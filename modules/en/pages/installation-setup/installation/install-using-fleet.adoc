<<<<<<< HEAD:modules/en/pages/deploy/install/install-with-fleet.adoc
= Install with Fleet
:weight: 10
...
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/installation-setup/installation/install-using-fleet.adoc
