...
<<<<<<< HEAD:modules/en/pages/deploy/install/install-with-kubectl.adoc
:weight: 8
:current-version: {page-component-version}
=======
:current-version: {page-origin-branch}
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/installation-setup/installation/install-using-kubectl.adoc
