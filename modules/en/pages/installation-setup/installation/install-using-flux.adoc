<<<<<<< HEAD:modules/en/pages/deploy/install/install-with-flux.adoc
= Install with Flux
:weight: 11
...
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/installation-setup/installation/install-using-flux.adoc
