<<<<<<< HEAD:modules/en/pages/deploy/install/install-with-helm.adoc
= Install with Helm
:weight: 9
...
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/installation-setup/installation/install-using-helm.adoc
