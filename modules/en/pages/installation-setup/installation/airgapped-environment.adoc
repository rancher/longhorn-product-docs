...
:doctype: book
<<<<<<< HEAD:modules/en/pages/deploy/install/airgap.adoc
:weight: 100
:current-version: {page-component-version}
=======
:current-version: {page-origin-branch}
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/installation-setup/installation/airgapped-environment.adoc
