<<<<<<< HEAD:modules/en/pages/advanced-resources/os-distro-specific/container-optimized-os-support.adoc
...
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/installation-setup/os-distro/container-optimized-os.adoc
