<<<<<<< HEAD:modules/en/pages/deploy/install/index.adoc
= Quick Installation
...
=======
= Requirements
>>>>>>> 86aba05 (Implement new IA (Introduction, Installation and Setup, Upgrades)):modules/en/pages/installation-setup/requirements.adoc
