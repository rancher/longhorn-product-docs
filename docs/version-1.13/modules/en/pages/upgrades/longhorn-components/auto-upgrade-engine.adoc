...
[NOTE]
====
This engine upgrade procedure applies only to V1 Data Engine volumes. For V2 Data Engine, see xref:upgrades/longhorn-components/v2-instance-upgrade.adoc[V2 Data Engine Instance Manager Upgrade Page].
====
