...
----
Follow the https://docs.apps.rancher.io/get-started/authentication/#kubernetes[Kubernetes authentication documentation] to create a secret in namespace `longhorn-system`
[,shell]
----
...
+
. Click Next. In the yaml editor, add the value `application-collection` in field `global.imagePullSecrets`
+
