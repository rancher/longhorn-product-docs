...
Do not install or upgrade host nodes to `open-iscsi 2.1.12`. A breaking configuration change in the upstream `open-iscsi 2.1.12` causes volume attachment failures. Use `open-iscsi \<= 2.1.11` or `>= 2.1.13` instead. For more information, see upstream issue https://github.com/open-iscsi/open-iscsi/issues/540[issue] and {longhorn-product-name} https://github.com/longhorn/longhorn/issues/13733[#13733].
====
