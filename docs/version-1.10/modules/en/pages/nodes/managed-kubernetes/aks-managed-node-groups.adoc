...
:description: Configure and manage your Azure Kubernetes Service (AKS) cluster by adding a new node pool, coordinating nodes within the existing pool, and deleting outdated.
:revdate: 2025-06-27
