...
:description: Configure the launch template for an EKS cluster to update both node configurations and recycle nodes with new settings whenever you update the template.
:revdate: 2025-06-27
