= Node Selector
:description: Learn how to restrict Longhorn components to specific nodes by setting a node selector for both user-deployed and system-managed components.
:revdate: 2025-06-27
