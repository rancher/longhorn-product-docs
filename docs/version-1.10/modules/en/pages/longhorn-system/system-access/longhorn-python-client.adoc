= Python Client
:description: Configure and interact with Longhorns API using the Python binding by following detailed steps to access endpoints via either the longhorn-frontend service.
:revdate: 2025-06-27
