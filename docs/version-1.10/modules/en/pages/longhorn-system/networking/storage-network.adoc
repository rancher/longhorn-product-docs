= Storage Network
:description: Learn how to configure the Storage Network setting in Longhorn to isolate in-cluster data traffic and segregate network access for your workloads.
:revdate: 2025-06-27
