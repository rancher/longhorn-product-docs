= Networking
:description: Configure network policies to control both inbound and outbound traffic between Longhorn components, thereby reducing damage from malicious pods.
:revdate: 2025-07-12
