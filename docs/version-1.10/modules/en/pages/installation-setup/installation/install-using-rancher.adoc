...
:description: Configure Longhorn through Rancher Apps & Marketplace, using its built-in authentication and leveraging network policies to grant access to the Longhorn.
:revdate: 2025-07-26
