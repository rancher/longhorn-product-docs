= Volume Size
:description: Explore how the nominal and actual sizes of a Longhorn volume are calculated and updated in response to various file system operations, such as writing data.
:revdate: 2025-07-29
