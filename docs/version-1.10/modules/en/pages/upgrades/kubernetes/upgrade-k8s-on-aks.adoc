...
:description: Learn how to safely upgrade AKS (Azure Kubernetes Service) clusters with az aks upgrade commands, which support both control plane and agent node upgrades.
:revdate: 2025-06-27
