...
:description: Learn how to successfully upgrade your Longhorn installation by following these step-by-step instructions, adapted to your specific Rancher environment setup.
:revdate: 2025-07-29
