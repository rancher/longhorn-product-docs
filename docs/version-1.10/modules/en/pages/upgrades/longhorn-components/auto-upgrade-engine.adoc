...
:description: Learn how to automatically upgrade Longhorn volumes to the new default engine version after upgrading to the latest Longhorn Manager release with minimal manual.
:revdate: 2025-06-27
